...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'global-nav',         title: 'GlobalNav',         category: 'App', abbr: 'GN' },
      { id: 'app-sidebar',        title: 'AppSidebar',        category: 'App', abbr: 'Ab' },
      { id: 'dashboard-sidebar',  title: 'DashboardSidebar',  category: 'App', abbr: 'Db' },
      { id: 'app-top-bar',        title: 'AppTopBar',         category: 'App', abbr: 'AT' },
      { id: 'dashboard-top-bar',  title: 'DashboardTopBar',   category: 'App', abbr: 'DT' },
